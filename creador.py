...
def crear_instancia(costo_max_camion=None, n=None, cant_exclusivos=None,
                    cant_refrigerados=None, dist_max=None, costo_repartidor=None):
    ids = [str(i) for i in range(1, n + 1)]
    # Primeras lineas de la entrada
    file = open(f"instancias/instancia_{n}.txt", "w")
    file.write(f"{n}\n")
...
def main():
    ...
    for n in [40, 45, 50, 55, 60, 65, 70]:
        ...
        crear_instancia(costo_max_camion, n, cant_refrigerados, cant_exclusivos, dist_max, costo_repartidor)
